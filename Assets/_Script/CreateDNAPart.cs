...
public class CreateDNAPart : MonoBehaviour
{
    ...
    {
        Init();
        //this.gameObject.AddComponent<MovePosition>();
    }

    void Update()
    {
        this.gameObject.transform.localScale = Vector3.one;//为了是其较好的呈现
        ...
        //  this.transform.position = this.transform.parent.position;
            ...
            {
                if (jjd.transform.name == "0" || jjd.transform.name == "1" || jjd.transform.name == "2")
                {
                    jjd.transform.localScale = new Vector3(jjd.transform.localScale.x, 0.637F, jjd.transform.localScale.z);
                }
            } 
    ...
    void Init()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            if (i == 0|| i == 1)
            {
                obj[i + 1] = GameObject.Instantiate(A_L);
                obj[i + 1].tag = "DP";
            ...
            {
                obj[i + 1] = GameObject.Instantiate(T_L);
                obj[i + 1].tag = "DP";
            }
           else  if (i == count-3 || i == count - 4)
            {
                obj[i + 1] = GameObject.Instantiate(T_R);
                obj[i + 1].tag = "DP";
            }
          else   if (i == count-1 || i == count - 2)
            {
                obj[i + 1] = GameObject.Instantiate(A_R);
                obj[i + 1].tag = "DP";
            }
            else
            {
            ...
            if (i == (count - 5))
            {
                ...
                {
                    obj[i + 1].transform.Find("A").transform.Find("A_p1").transform.tag = "2";
                }
                if (obj[i + 1].transform.name == "T_A test (Clone)")
                {
                    obj[i + 1].transform.Find("T").transform.Find("T_p1").transform.tag = "2";
                }
                if (obj[i + 1].transform.name == "C_G test(Clone)")
                {
                    obj[i + 1].transform.Find("C").transform.Find("C_p1").transform.tag = "2";
                }
                if (obj[i + 1].transform.name == "G_C test(Clone)")
                {
                    obj[i + 1].transform.Find("G").transform.Find("G_p1").transform.tag = "2";
                }
            }
            if (i == 4)
            {
                if (obj[i + 1].transform.name == "A_T test(Clone)")
                {
                    obj[i + 1].transform.Find("T").transform.Find("T_p2").transform.tag = "4";
                }
                if (obj[i + 1].transform.name == "T_A test (Clone)")
                {
                    obj[i + 1].transform.Find("A").transform.Find("A_p2").transform.tag = "4";
                }
                if (obj[i + 1].transform.name == "C_G test(Clone)")
                {
                    obj[i + 1].transform.Find("G").transform.Find("G_p2").transform.tag = "4";
                }
                if (obj[i + 1].transform.name == "G_C test(Clone)")
                {
                    obj[i + 1].transform.Find("C").transform.Find("C_p2").transform.tag = "4";
                }
            }

            if (i==(count-1))
            {
                obj[i + 1].transform.Find("A").transform.Find("A_p1").transform.tag = "5";
        ...
        for (int i = 1; i < 2; i++)
        {
            obj[i].transform.transform.Find("A").transform.Find("A_p2").tag = "Candy1";
        }
        ...
        for (int i = 1; i <= 4; i++)
        {
            ...
            if (obj[i].transform.name == "A_L(Clone)")
            {
                if (obj[i + 1].transform.name == "A_L(Clone)")
                {
                    #region  在A 一侧产生磷酸二脂键
                ...
                if (obj[i + 1].transform.name == "T_L(Clone)")
                {
                    #region  在A_T一侧
                    GameObject A_p1 = obj[i].transform.Find("A").transform.Find("A_p1").gameObject;
            ...
            if (obj[i].transform.name == "T_L(Clone)")
            {
                if (obj[i + 1].transform.name == "T_L(Clone)")
                {
                    #region  在T一侧
                ...
                if (obj[i + 1].transform.name == "A_T test(Clone)")
                {
                    ...
                    AT_line = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
                    AT_line.GetComponent<CapsuleCollider>().isTrigger = true;
                    AT_line.transform.position = Vector3.Lerp(T_p1.transform.position, A_p2.transform.position, 0.5F);
                    AT_line.transform.localRotation = Quaternion.Euler(new Vector3(-80, (i - 2) * 36, 85));
                    AT_line.transform.localScale = new Vector3(0.1f, 1.2f, 0.1f);
                    AT_line.GetComponent<Renderer>().material.color = Color.black;
                    AT_line.transform.name = "LSEZJ_L";
                    AT_line.transform.parent = obj[i].transform.Find("T").transform;
                }
                if (obj[i + 1].transform.name == "T_A test (Clone)")
                {
                    GameObject T_p1 = obj[i].transform.Find("T").transform.Find("T_p1").gameObject;
                ...
                if (obj[i + 1].transform.name == "C_G test(Clone)")
                {
                    ...
                    GameObject TC_line;
                    TC_line = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
                ...
                if (obj[i + 1].transform.name == "G_C test(Clone)")
                {
                    ...
                    GameObject TG_line;
                    TG_line = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
        ...
        for (int i = count -4; i < count; i++)
        {
            if (obj[i].transform.name == "A_T test(Clone)")
            {
                if (obj[i + 1].transform.name == "T_R(Clone)")
                {
                    #region  在AT 一侧产生磷酸二脂键
                    GameObject T_p1 = obj[i].transform.Find("T").transform.Find("T_p1").gameObject;
                    GameObject T_p2 = obj[i + 1].transform.Find("T").transform.Find("T_p2").gameObject;
                    GameObject T_line;
                    T_line = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
            ...
            else if (obj[i].transform.name == "G_C test(Clone)")
            {
                if (obj[i + 1].transform.name == "T_R(Clone)")
                {
                    #region  在GT 一侧产生磷酸二脂键
            ...
            if (obj[i].transform.name == "T_R(Clone)")
            {
                if (obj[i + 1].transform.name == "T_R(Clone)")
                {
                    #region  在T 一侧产生磷酸二脂键
                ...
                if (obj[i + 1].transform.name == "A_R(Clone)")
                {
                    #region  在A_T一侧
                    GameObject T_p1 = obj[i].transform.Find("T").transform.Find("T_p1").gameObject;
                    GameObject A_p2 = obj[i + 1].transform.Find("A").transform.Find("A_p2").gameObject;
            ...
            if (obj[i].transform.name == "A_R(Clone)")
            {
                if (obj[i + 1].transform.name == "A_R(Clone)")
                {
                    #region  在A一侧
        ...
        this.gameObject.transform.position = new Vector3(10F, -10, 13);
